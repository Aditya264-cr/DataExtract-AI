...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({ isOpen, onClose }) => {
    ...
    const Select = ({ value, onChange, options }: { value: string, onChange: (val: any) => void, options: { value: string, label: string }[] }) => (
        <select 
            value={value} 
                            ...
                            <div className="pt-2">
                                {activeTab === 'appearance' && (
                                    <div className="animate-fade-in space-y-2">
                                        ...
                                        <SettingRow 
                                            ...
                                            description="Adjust the ambient atmosphere based on the season." 
                                            control={
                                                <Select 
                                                    value={settings.season} 
                                                    onChange={(v) => updateSetting('season', v)}
                                                    options={[
                                                        { value: 'auto', label: 'Auto (Date)' },
                                ...
                                {activeTab === 'output' && (
                                    <div className="animate-fade-in space-y-2">
                                        ...
                                        <SettingRow title="Watermark on Exports" description="Add 'Generated by DataExtract AI' to files." control={<ToggleSwitch checked={settings.showWatermark} onChange={(e) => updateSetting('showWatermark', e.target.checked)} />} />
                                    </div>
                                )}
